function mergeRanges(meetings) {
  ...
  for (let i = 0; i<meetings.length; i++) {
    ...
    if (lastMeeting.endTime >= currMeeting.startTime) {
      lastMeeting.endTime = lastMeeting.endTime > currMeeting.endTime ? lastMeeting.endTime : currMeeting.endTime;
    } else {
